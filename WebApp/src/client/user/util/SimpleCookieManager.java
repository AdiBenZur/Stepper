...
public class SimpleCookieManager implements CookieJar {
    ...
    // Manages cookies for Http requests and responses.

    private final static String CACHE_MANAGER_PREFIX = "    [Cookie Manager] ---> ";
    Map<String, Map<String, Cookie>> cookies = new HashMap<>(); // <host\domain, <cookie name, cookie itself>>
    private Consumer<String> logData = System.out::println; // Initialize method
