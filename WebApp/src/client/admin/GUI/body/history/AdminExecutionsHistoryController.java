...
import client.user.GUI.body.history.ExecutionHistoryRowData;
...
public class AdminExecutionsHistoryController {
    ...
    @FXML
    private TableColumn<ExecutionHistoryRowData, String> runByColumn;;
    @FXML
    ...
    private List<ExecutionDetailsHeadlines> executions;
    private Timer timer;
    private TimerTask listRefresher;


    public AdminExecutionsHistoryController() {
    ...
    public void initialize() {
        ...
        runByColumn.setCellValueFactory(new PropertyValueFactory<ExecutionHistoryRowData, String>("runBy"));
    ...
    public void updateExecutionsList(List<ExecutionDetailsHeadlines> executionsList) {
        // Update table
        Platform.runLater(() -> {
            activate(executionsList);
        });
    }

    public void startListRefresher() {
        listRefresher = new ExecutionsHistoryRefresher(
    ...
    public void activate(List<ExecutionDetailsHeadlines> executionsList) {
        ...
        for(ExecutionDetailsHeadlines headlines : executionsList) {
            ...
            if(filterOption.equals("ALL") || headlines.getResult().equals(filterOption)) {
                ExecutionHistoryRowData historyRowData = new ExecutionHistoryRowData(name, time, result, runBy , button);
